...
interface HorizontalProductsScrollProps {
  products: Product[];
...
// Horizontal Products Scroll Component
const HorizontalProductsScroll: React.FC<HorizontalProductsScrollProps> = ({
  products,
  onProductClick,
  onViewMoreClick,
  title = "Complete Product Suite",
  subtitle = "Scroll through our entire collection of enterprise-grade solutions"
}) => {
  // Show first 5 products in horizontal scroll
        ...
        <div className="flex space-x-6 w-max">
          {displayProducts.map((product) => (
            ...
            >
              ...
              {/* Product Content - Increased padding */}
              <div className="p-7">
...
// Main Combined Component with Demo
function App() {
  const [selectedProduct, setSelectedProduct] = useState<Product | null>(null);
  const [currentView, setCurrentView] = useState<'gallery' | 'detail' | 'all-products'>('gallery');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Horizontal Products Gallery
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover our complete suite of enterprise solutions
          </p>
